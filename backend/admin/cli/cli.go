...
func NewDexCli() *cli.App {
	...
	app := cli.NewApp()
	app.Usage = "A tool to manage eosb dex"
	app.Version = "0.0.1"
	app.Name = "eosb-dex-ctl"
    ...
    hydor-dex-ctl market changeFees HOT-WETH "0.001" "0.003"`,
		...
		//				if len(address) == 0 {
		//					fmt.Println("missing arguments, usage: eosb-dex-cli address orders address --marketID=xxx")
		//					return nil
		//				}
		//
		//				if len(marketID) == 0 {
		...
		//				address := c.Args().Get(0)
		//				if len(address) == 0 {
		//					fmt.Println("missing arguments, usage: eosb-dex-cli address balances address")
		//					return nil
		//				}
		//
		...
		//				address := c.Args().Get(0)
		//				if len(address) == 0 {
		//					fmt.Println("missing arguments, usage: eosb-dex-cli address trades address --marketID=xxx")
		//					return nil
		//				}
		//
		//				if len(marketID) == 0 {
		...
		//				if len(orderID) == 0 {
		//					fmt.Println("missing arguments, usage: eosb-dex-cli order cancel orderID")
		//					return nil
		//				}
		//
