module github.com/teameosb/edex/backend

go 1.12

require (
	github.com/teameosb/eosb-sdk-backend v0.0.41
	github.com/teameosb/eth-watcher v0.2.0
...
// for local test only
//replace github.com/teameosb/eosb-sdk-backend => ../../eosb-sdk-backend
//replace github.com/teameosb/eth-watcher => ../../eth-watcher
